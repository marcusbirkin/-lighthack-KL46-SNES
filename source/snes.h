...
const static char SNES_KONAMI_ARRAY[] =
	{SNES_BUTTON_UP, SNES_BUTTON_UP,
	SNES_BUTTON_DOWN, SNES_BUTTON_DOWN,
	SNES_BUTTON_LEFT, SNES_BUTTON_RIGHT,
	SNES_BUTTON_LEFT, SNES_BUTTON_RIGHT,
	SNES_BUTTON_B, SNES_BUTTON_A};
uint8_t SNES_KONAMI_INDEX = 0;
