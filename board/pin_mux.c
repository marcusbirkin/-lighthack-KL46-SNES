...
- {pin_num: '84', pin_signal: LCD_P28/CMP0_IN2/PTC8/I2C0_SCL/TPM0_CH4/I2S0_MCLK/LCD_P28_Fault, label: 'J1[14]/D6', identifier: SNES_CLK}
- {pin_num: '85', pin_signal: LCD_P29/CMP0_IN3/PTC9/I2C0_SDA/TPM0_CH5/I2S0_RX_BCLK/LCD_P29_Fault, label: 'J1[16]/D7', identifier: SNES_LAT}
...
- {pin_num: '43', pin_signal: PTA13/TPM1_CH1/I2S0_TX_FS, label: 'J2[2]/D8', identifier: SNES_DATA}
...
- options: {callFromInitBoot: 'true', prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '26', peripheral: GPIOE, signal: 'GPIO, 29', pin_signal: CMP0_IN5/ADC0_SE4b/PTE29/TPM0_CH2/TPM_CLKIN0, direction: OUTPUT, slew_rate: slow, pull_select: down,
    pull_enable: disable}
...
- pin_list:
  - {pin_num: '84', peripheral: GPIOC, signal: 'GPIO, 8', pin_signal: LCD_P28/CMP0_IN2/PTC8/I2C0_SCL/TPM0_CH4/I2S0_MCLK/LCD_P28_Fault, direction: OUTPUT, slew_rate: fast,
    pull_select: up, pull_enable: enable}
  - {pin_num: '85', peripheral: GPIOC, signal: 'GPIO, 9', pin_signal: LCD_P29/CMP0_IN3/PTC9/I2C0_SDA/TPM0_CH5/I2S0_RX_BCLK/LCD_P29_Fault, direction: OUTPUT, pull_select: down,
    pull_enable: enable}
  - {pin_num: '43', peripheral: GPIOA, signal: 'GPIO, 13', pin_signal: PTA13/TPM1_CH1/I2S0_TX_FS, direction: INPUT, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitSnes
 * Description   : Config pins for SNES controller
 *
 * END ****************************************************************************************************************/
void BOARD_InitSnes(void)
{
    ...
    PORT_SetPinMux(BOARD_INITSNES_SNES_DATA_PORT, BOARD_INITSNES_SNES_DATA_PIN, kPORT_MuxAsGpio);
    ...
    const port_pin_config_t SNES_CLK = {/* Internal pull-up resistor is enabled */
                                        kPORT_PullUp,
                                        /* Fast slew rate is configured */
                                        kPORT_FastSlewRate,
                                        /* Passive filter is disabled */
    ...
    PORT_SetPinConfig(BOARD_INITSNES_SNES_CLK_PORT, BOARD_INITSNES_SNES_CLK_PIN, &SNES_CLK);

    /* PORTC9 (pin 85) is configured as PTC9 */
    PORT_SetPinMux(BOARD_INITSNES_SNES_LAT_PORT, BOARD_INITSNES_SNES_LAT_PIN, kPORT_MuxAsGpio);
